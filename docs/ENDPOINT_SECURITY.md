...
| `/api/track` | POST | Public write | Zod, tracking rate policy, four-event public allow-list, server-namespaced idempotency key; capability required for lead association, otherwise anonymous |
